...
df = df.drop(
    columns=[
        "AvgGS",
        "AvgGA",
        "Estimated_Wins_Extended",
        "Estimated_Draws_Extended",
...
def calculate_array_of_deltas_for_all_sezons():
    ...
    for i in range(2014, 2022):
        ...
        df_for_array = df_for_array.drop(
            columns=[
                "AvgGS",
                "AvgGA",
                "Estimated_Wins_Extended",
...
def create_estimated_points_of_one_sezon_figure(
    data_frame,
    data_x_axis,
    data_y1_axis,
    data_y2_axis,
...
def create_avg_deltas_figure(
    data_frame, title, y_column_name, blue_line_name, black_line_name
):
    sezons = [
        "2014-2015",
        "2015-2016",
    ...
    (
        array_of_simple_deltas,
        array_of_extended_deltas,
    ) = calculate_array_of_deltas_for_all_sezons()
...
if __name__ == "__main__":
    ...
    create_estimated_points_of_one_sezon_figure(
        df,
        df["Team"],
        dx,
        estimated_simple_pyth,
        estimated_extended_pyth,
        "Estimated points by 2 formulas in 2014/15 season",
        "Points",
        "Points recorded",
        "Points estimated by Simple Pythagorian method",
        "Points estimted by Extended Pythagorian method",
    )

    create_avg_deltas_figure(
        df,
        "Estimated points by the 2 formulas",
        "Points",
        "Average delta points with simple pithagoryan",
