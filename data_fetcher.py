...
async def get_fixtures_in_league_for_season(league, start_year, end_year):
    async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=False)) as session: 
        ...
        create_empty_directories('jsons', 'fixtures', league, start_year, end_year, False)
        # generate empy folders for dataframes
        create_empty_directories('dataframes', 'fixtures', league, start_year, end_year, False)
        create_empty_directories('dataframes', 'clean_sheets', league, start_year, end_year, False)
        ...
        for year in range(start_year, end_year):
                ...
                with open(f'jsons/fixtures/{league}/{league}_fixtures_in_{path_season}.json', 'w') as outfile:
...
if __name__ == "__main__":
    ...
    for league in leagues_list:
        ...
        print(league)
        loop = asyncio.get_event_loop()
        loop.run_until_complete(get_fixtures_in_league_for_season(league, 2014, 2022))
